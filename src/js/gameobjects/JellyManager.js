...
export default class JellyManager {
  ...
  growJelly(x, y, player) {
    ...
    if (this.isThereAJellyAt(x, y)) {
      ...
      this.addJelly(x, y, posx, posy, player);
    }
  }
  ...
  executeSplash() {
    if (this.executeSplashes.length > 0) {
      this.animationBuzy = true;
    }
